          ...
          <div class="col-sm-12 col-md-10 entries">
              ...
              <article class="entry">
                  <div class="row">
                      ...
                      <div class="col-sm-10 col-md-8">
                          <h2 class="entry-title px-4">
                              <a href="\realisations\3">Développement des méthodes de technologie</a>
                          </h2>
                          <div class="entry-content">
                              <h4>
